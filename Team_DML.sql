...
DELETE FROM MEMBER
WHERE MEM_ID LIKE 'A8';


ALTER TABLE MEMBER ADD(SSN VARCHAR2(8));
ALTER TABLE MEMBER DROP COLUMN age; 
ALTER TABLE MEMBER ADD(AGE DECIMAL);

UPDATE MEMBER
SET AGE=
    CASE
    WHEN NAME LIKE '형준' THEN 34
    WHEN NAME LIKE '세인' THEN 35
    WHEN NAME LIKE '희태' THEN 21
    WHEN NAME LIKE '상훈' THEN 29
    WHEN NAME LIKE '태형' THEN 25
    WHEN NAME LIKE '혜리' THEN 26
    WHEN NAME LIKE '지은' THEN 26
    WHEN NAME LIKE '준' THEN 27
    WHEN NAME LIKE '재경' THEN 30
    WHEN NAME LIKE '단아' THEN 26
    WHEN NAME LIKE '최정훈' THEN 23
    WHEN NAME LIKE '윤호' THEN 31
    WHEN NAME LIKE '가은' THEN 29
    WHEN NAME LIKE '정훈' THEN 23
    WHEN NAME LIKE '승태' THEN 30
    WHEN NAME LIKE '승호' THEN 27
    WHEN NAME LIKE '소진' THEN 26
    WHEN NAME LIKE '이슬' THEN 29
    WHEN NAME LIKE '진태' THEN 26
    WHEN NAME LIKE '누리' THEN 30
    END;
